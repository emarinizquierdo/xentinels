...
ROUTES = [
    ...
    webapp2.Route(
        r'/api/login/<:.*>', server.login.Login, handler_method='any'),
    RESTHandler(
...
# Make sure we initialize our WSGIApplication with this config (used for
# initializing webapp2_extras.sessions)
config = {}
